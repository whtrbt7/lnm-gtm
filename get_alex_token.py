...
Run this, log in with achiu@leadsnearme.com in the browser window that opens,
then grant permissions. Token is saved to token_alex.json.

Usage:
    python get_alex_token.py
"""
...
print('IMPORTANT: Log in with achiu@leadsnearme.com')
print()
...
print('  python push_gtm_setup.py --tier 3 --token-file token_alex.json --rebuild-index')
