"""
One-time script to generate OAuth credentials for analytics2@leadsnearme.com.
Usage: python get_analytics2_token.py
"""
...
TOKEN_OUT = os.path.join(SCRIPT_DIR, 'token_analytics2.json')
...
print(f'IMPORTANT: Log in with analytics2@leadsnearme.com')
print()
